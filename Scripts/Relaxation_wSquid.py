...
d=0.0996032153487
current = np.linspace(0.039, 0.045, 5501)
...
# plt.semilogy(current*1e3 + (41.6813-41.6413),1.0/gamma_qp1[:,0]*1e6,'m-')
# plt.semilogy(current*1e3 + (41.6813-41.6413),1.0/gamma_ind1*1e6,'g-')
