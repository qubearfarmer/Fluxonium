...
directory = 'G:\Projects\Fluxonium\Data\\Fluxonium #21\\Two_tone'

measurement = '012818_Two_tone_spec_YOKO_0to0.6mA_Cav_7.3244GHz&0dBm_QuBit3.5to5GHz&15dBm'
...
measurement = '012818_Two_tone_spec_YOKO_0.408to0.7mA_Cav_7.3244GHz&0dBm_QuBit4.1to4.3GHz&15dBm'
path = directory + '\\' + measurement
...
current_nice = np.linspace(0, 0.7, 71)*1e-3 #In A
