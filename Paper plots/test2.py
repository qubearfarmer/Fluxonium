...
# T1 = np.array([47, 40, 150, 2600,617,531,421,257,773,1054,175,550,599,22,24,19, 38, 31])
# pem = np.array([0.7, 0.82, 0.081, 0.051, 0.045, 0.047, 0.049, 0.054, 0.0599, 0.0649,0.105,0.113,0.121,0.76,0.76,0.76,0.82,0.82])
T1_array = []
freq_array = []
flux_array = []
...
simulation = "T1_auto_41to41p05mA_corrected flux.TXT"
path = directory + "\\" + simulation
...
simulation = "T1_auto_41p55to41p6mA_corrected flux.TXT"
path = directory + "\\" + simulation
data = np.genfromtxt(path)
flux = data[1:, 0]
freq = data[1:, 1]
...
simulation = "T1_auto_37p2to38p5mA_1_corrected flux.TXT"
path = directory + "\\" + simulation
data = np.genfromtxt(path)
flux = data[:, 0]
freq = data[:, 1]
