# Analyze T1 data from 0.5-1.5 GHz
import numpy as np
...
for idx in range(len(T1)):
    if (energies2[idx, 2] - energies2[idx, 1]) > 0.65 and (energies2[idx, 2] - energies2[idx, 1]) < 1.5 \
