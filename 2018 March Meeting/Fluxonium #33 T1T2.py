...
#################################################################################################################
# Parameters
directory = 'G:\Projects\Fluxonium\Data\Julius II\T2E'
fname = '092618_T1T2ET2R_loop_YOKO_31.021mA_Cav7.5064GHz_-30dBm_Qubit0.32125GHz_0dBm__PiPulse194ns_Count20_TimeStepT140000_TimeStepT2E24000_TimeStepT2R2000_loop51.h5'
...
print(np.corrcoef(T2e_array[1:] / T1_array[1:], np.diff(f_R_array))[0, 1])
