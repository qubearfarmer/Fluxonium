...
current_flux = current - 0.052
current_flux = current_flux * 0.5/1.5
X,Y = np.meshgrid(current_flux,freq)
...
#     return energy
# plt.plot(current_flux, trans_energy(current, E_l, E_c, E_j, A, offset, 0, 1),linestyle ='--',dashes=(10,10), linewidth = 1, color ='black')
# plt.plot(current_flux, trans_energy(current, E_l, E_c, E_j, A, offset, 0, 2),linestyle ='--',dashes=(10,10), linewidth = 1, color ='black')
# plt.plot(current_flux, trans_energy(current, E_l, E_c, E_j, A, offset, 1, 2),linestyle ='--',dashes=(10,10), linewidth = 1, color ='black')
# plt.plot(current_flux[0:70], trans_energy(current[0:70], E_l, E_c, E_j, A, offset, 0, 4)-7.326,linestyle ='--',dashes=(10,10), linewidth = 1, color ='black')
plt.tick_params(labelsize=32.0)
plt.ylim([0,5])
